...
<model ref="r:71d9a8e5-dab8-426e-bc30-99d08412227e(Algorithm.editor)">
  ...
  <node concept="24kQdi" id="6VQU7by$sla">
    <ref role="1XX52x" to="yvgz:6VQU7byzDMj" resolve="DataConnection" />
    <node concept="3EZMnI" id="6VQU7by$slc" role="2wV5jI">
      <node concept="l2Vlx" id="6VQU7by$sld" role="2iSdaV" />
      <node concept="1iCGBv" id="6VQU7by$slg" role="3EZMnx">
        <ref role="1NtTu8" to="yvgz:6VQU7byzDnw" resolve="instance" />
        <node concept="1sVBvm" id="6VQU7by$slj" role="1sWHZn">
          <node concept="3F0A7n" id="6VQU7by$sll" role="2wV5jI">
            <ref role="1NtTu8" to="tpck:h0TrG11" resolve="name" />
          </node>
        </node>
      </node>
      <node concept="3F0ifn" id="6VQU7by$slm" role="3EZMnx">
        <property role="3F0ifm" value="-&gt;" />
      </node>
  ...
  <node concept="24kQdi" id="6VQU7bz8DVm">
    <ref role="1XX52x" to="yvgz:6VQU7bz8DV0" resolve="TriggerConnection" />
    <node concept="3EZMnI" id="6VQU7bz8DVo" role="2wV5jI">
      <node concept="l2Vlx" id="6VQU7bz8DVp" role="2iSdaV" />
      <node concept="1iCGBv" id="6VQU7bz8DVs" role="3EZMnx">
        <ref role="1NtTu8" to="yvgz:6VQU7byzDnw" resolve="instance" />
        <node concept="1sVBvm" id="6VQU7bz8DVv" role="1sWHZn">
          <node concept="3F0A7n" id="6VQU7bz8DVx" role="2wV5jI">
            <ref role="1NtTu8" to="tpck:h0TrG11" resolve="name" />
          </node>
        </node>
      </node>
      <node concept="3F0ifn" id="6VQU7bz8DVy" role="3EZMnx">
        <property role="3F0ifm" value="-&gt;" />
      </node>
